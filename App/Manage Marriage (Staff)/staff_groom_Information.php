...
<header>
    ...
    <div class="container">
        ...
        <table class="table1" border="1" align="center">
            <tr>
                <th class="th1">MAKLUMAT PEMOHON</th>
            </tr>
            <tr>
                <td class="td1">
                ...
                <form>
                    ...
                    <div class="setting">
                        <a href="staff_approval_page.php"><button class="button2 back1">Kembali</button></a>
                        <a href="staff_bride_Information.php"><button class="button2 back1">Seterusnya</button></a>
                    </div>
