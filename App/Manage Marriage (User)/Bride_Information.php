        ...
        <table class="table1" border="1" align="center">
            ...
            <tr>
                ...
                <form>  
                    ...
                    <div class="setting">
                        <a href="Groom_Information.php"><button class="button2 back1">Kebelakang</button></a>
                        <a href="marriage_registration.php"><button name="submit" class="button2 back1">Confirm</button></a>
                    </div>
